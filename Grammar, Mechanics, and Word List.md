...
> You can use Zapier with MailChimp, Trello, and Slack.
...
A handful of integrations on our platform are marked as [Premium apps](https://zapier.com/zapbook/#sort=premium&filter=all). You need a paid account to use these apps. 
...
For a more in-depth breakdown of Zapier-specific terms, check out the [Writing about Zapier](#writing-about-zapier) section.

Words are listed with their proper capitalization. Capitalize words at the beginning of sentences except for camel case words (like eCommrece and eBook).
...
- Zap, never zap
- Zapier, never zapier
- Trigger / Action (noun in relation to a Zap), trigger (verb), trigger / action (.
- step (not Step)
